...
class AnimalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post animals_url, params: { animal: { age: @animal.age, breed: @animal.breed, name: @animal.name } }
    end
  ...
  test "should update animal" do
    patch animal_url(@animal), params: { animal: { age: @animal.age, breed: @animal.breed, name: @animal.name } }
